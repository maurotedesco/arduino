...
void tempo(int runFor) {
   for(int timer = runFor;timer > 0; --timer){
    //switch(timer) {
      //case timer > 1000: lcd.setCursor(0,1); break;
      //case timer > 100: lcd.setCursor(1,1); break;
      //case timer < 10: lcd.setCursor(2,1); break;
      //default: lcd.setCursor(3,1) ; return;
    //}
    lcd.setCursor(0,1);
    lcd.print(timer);
    lcd.print("S=");
